...
// Leadership team card component for CEO, Co-founder, and Managing Partner
const LeadershipTeamCard = ({ member }: { member: TeamMember }) => {
  return (
    <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg overflow-hidden shadow-md border border-gray-200 p-6">
      <div className="flex flex-col md:flex-row items-center">
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          {member.languages && member.languages.length > 0 && (
            <div className="mb-4">
              <p className="text-sm text-gray-700 font-medium">Languages: {member.languages.join(', ')}</p>
            </div>
          )}
