          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <FadeInLeft>
              ...
              <StaggerContainer className="space-y-8" delay={0.2}>
                <StaggerItem>
                  <motion.div
                    className="flex items-start p-6 bg-gray-50 rounded-xl border-l-4 border-gray-700"
                    whileHover={{
                      x: 5,
                  ...
                  >
                    <div className="flex-shrink-0">
                      <motion.div
                        className="w-12 h-12 rounded-full bg-gradient-to-r from-gray-500 to-gray-900 flex items-center justify-center"
              ...
              <FadeInUp delay={0.4} className="mt-12 p-6 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl shadow-sm">
                <h3 className="text-lg font-bold text-gray-900 mb-4">Follow Us</h3>
                <div className="flex space-x-4">
                  <motion.a
                    href="#"
                    className="w-10 h-10 rounded-full bg-white flex items-center justify-center shadow-sm text-gray-700"
                    whileHover={{
                      scale: 1.1,
            ...
            <FadeInRight>
              <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100">
                ...
                {formSuccess ? (
                  <motion.div
                    className="bg-gray-100 border-l-4 border-gray-700 text-gray-700 p-6 rounded-lg mb-4"
                  ...
                  >
                    <div className="flex items-center mb-2">
                      <motion.svg
                        ...
                        stroke="currentColor"
                        initial={{ scale: 0 }}
                        animate={{ scale: 1, rotate: [0, 0, 0, 360] }}
                        transition={{ duration: 0.7, delay: 0.3, times: [0, 0.2, 0.8, 1] }}
                      >
                  ...
                  <form onSubmit={handleSubmit}>
                    {formError && (
                      <motion.div
                        className="bg-red-50 border-l-4 border-red-500 text-red-700 p-6 rounded-lg mb-6"
      ...
      <section className="py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <FadeInUp className="md:col-span-2 bg-white p-2 rounded-xl shadow-lg overflow-hidden" delay={0.2}>
              <motion.div
            ...
            <div className="flex flex-col gap-6">
              ...
              <FadeInUp delay={0.4}>
                ...
                >
                  ...
                  <StaggerContainer className="space-y-2" delay={0.1}>
                    <StaggerItem>
                      <motion.li
