          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <div className="space-y-8">
                <div className="flex items-start p-6 bg-gray-50 rounded-xl hover:shadow-md transition-all duration-300 border-l-4 border-gray-700">
              ...
              <div className="mt-12 p-6 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl shadow-sm">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="w-10 h-10 rounded-full bg-white flex items-center justify-center shadow-sm hover:shadow-md transition-all duration-300 hover:bg-gray-700 hover:text-white text-gray-700">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100">
              ...
              {formSuccess ? (
                <div className="bg-gray-100 border-l-4 border-gray-700 text-gray-700 p-6 rounded-lg mb-4">
                  <div className="flex items-center mb-2">
                    <svg className="h-6 w-6 text-gray-700 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
