    ...
    <div className="bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="flex flex-col gap-8">
          ...
          <div className="w-full">
            <div className="bg-gradient-to-r from-gray-700 to-gray-900 rounded-xl shadow-xl overflow-hidden">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-8">
                ...
                <div className="flex flex-col justify-center text-white">
                  ...
                  <div className="flex flex-wrap gap-4">
                    <button className="flex items-center px-6 py-3 bg-white text-gray-900 rounded-lg hover:bg-gray-100 transition duration-300 font-medium">
                      <svg className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
