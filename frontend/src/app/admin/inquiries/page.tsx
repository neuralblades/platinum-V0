                  ...
                  <tr key={inquiry.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <select
                        ...
                        className={`text-sm border rounded-lg px-2 py-1 focus:outline-none focus:ring-2 focus:ring-teal-500 shadow-sm transition-all ${
                ...
                <div className="bg-gray-50 p-4 rounded-lg border border-gray-100 shadow-sm">
                  <div className="mb-4">
                    ...
                    <select
                      ...
                      className={`mt-1 text-sm border rounded-lg px-2 py-1 focus:outline-none focus:ring-2 focus:ring-teal-500 shadow-sm transition-all ${
