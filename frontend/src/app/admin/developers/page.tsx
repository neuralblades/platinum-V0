                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div className="flex space-x-2">
                        <Link
                          ...
                          className="text-white bg-indigo-500 hover:bg-indigo-600 px-2 py-1 rounded-lg text-xs font-medium transition-colors duration-200 inline-flex items-center"
                        >
                          <svg className="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <Link
                          ...
                          target="_blank"
                          className="text-white bg-teal-500 hover:bg-teal-600 px-2 py-1 rounded-lg text-xs font-medium transition-colors duration-200 inline-flex items-center"
                        >
                          <svg className="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
