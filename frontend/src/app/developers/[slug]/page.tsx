      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-10 border border-gray-100">
          <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
            {developer.logo && (
              <div className="relative w-56 h-56 flex-shrink-0 bg-gray-50 p-4 rounded-lg border border-gray-100">
                <Image
        ...
        <div className="mb-8">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">Properties by {developer.name}</h2>
          <div className="w-20 h-1 bg-gradient-to-r from-gray-700 to-gray-900 mb-6"></div>
        </div>
      ...
      {properties.length === 0 ? (
        <div className="bg-white rounded-lg shadow-md p-8 text-center border border-gray-100">
          <div className="py-8">
            ...
            <p className="text-gray-600 text-lg">No properties found for this developer.</p>
          </div>
        </div>
      ) : (
        <>
